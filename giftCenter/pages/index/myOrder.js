...
Page({
  ...
  cancle:function(e){//取消订单
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://np.pigcms.com/cashier/merchants.php?m=Api&c=wxadoc&a=updateStauts',
            data: {
  ...
  pay:function(e){
    ...
    wx.request({
      url: 'https://np.pigcms.com/cashier/merchants.php?m=Api&c=wxadoc&a=payAgain',
      data: {
        mid:getApp().globalData.mid,
        id:id,      
        openid: getApp().globalData.openid,
  ...
  orderAgain:function(){//页面初始化
    ...
    wx.request({
      url: 'https://np.pigcms.com/cashier/merchants.php?m=Api&c=wxadoc&a=orderAgain',
      data: {
        mid: getApp().globalData.mid,
        openid: getApp().globalData.openid,
        unionid: getApp().globalData.unionid,
